  ...
  return (
    <Canvas shadows camera={{ position: [30, 0, -3], fov: 35, near: 1, far: 50 }}>
      ...
      <AccumulativeShadows temporal frames={100} color="lightblue" colorBlend={2} opacity={0.7} scale={60} position={[0, -5, 0]}>
        <RandomizedLight amount={10} radius={15} ambient={0.4} intensity={1} position={[-5, 10, -5]} size={20} />
      </AccumulativeShadows>
...
function Logo(props) {
  ...
  scene.children[0].material.color = new Color("#eeff15")
